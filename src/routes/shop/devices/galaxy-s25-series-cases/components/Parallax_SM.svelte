...
{#each section as { text, image }, i}
	<section class=" font-helvetica md:hidden ">
		<img src={image} alt="Parallax Background" class=" top-0 block box-border  w-full object-cover transition-transform sticky" />
